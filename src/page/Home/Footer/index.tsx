    ...
    return <footer className="bg-black py-[2.5em] w-[100%]">
        <Container className="text-white flex justify-between max-[671px]:flex-col max-[671px]:px-[3em]">
            ...
            <ul className="flex flex-col justify-between gap-[1em] text-center max-[671px]:text-left">
                ...
                <li><img src="/brand_white.svg" alt="Byte Bank" className="mx-auto max-[671px]:mx-[0]" /></li>
                <li className="flex justify-center gap-[1.5ch] max-[671px]:justify-start">
                    <img src="/instagram.svg" alt="Instagram da Bytebank" className="h-[2.5em]" />
                    <img src="/whatsapp.svg" alt="Whatsapp da Bytebank" className="h-[2.5em]" />
                    <img src="/youtube.svg" alt="Canal do youtube da Bytebank" className="h-[2.5em]" />
                </li>
            </ul>
        </Container>
    </footer>
